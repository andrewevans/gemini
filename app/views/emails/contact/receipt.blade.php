...
<head>
    ...
    <style type="text/css">
        ...
        ***********/
        ...
        #backgroundTable {margin:0; padding:0; width:100% !important; line-height: 100% !important; background:#cccc99}
        /* End reset */
        ...
        @media only screen and (max-device-width: 480px) {
            ...
            */
            ...
            .mobile_link a[href^="tel"], .mobile_link a[href^="sms"] {
                ...
                color: #004B91 !important; /* or whatever your want */
                pointer-events: auto;
                cursor: default;
            }
        }
...
<body style="margin:0;padding:0;font-family:arial;color:#333;background:#eee!important;text-align:center;">
...
<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
    <tr>
        <td>
            ...
            <a href="http://www.masterworksfineart.com"><img class="image_fix" src="{{ asset('img/theme/gemini/email/masterworks-fine-art.gif') }}" alt="Masterworks Fine Art Gallery" /></a>
            ...
            <p><span class="mobile_link">510-777-9970</span> / <span class="mobile_link">800-805-7060</span></p>


            <!-- Yahoo Link color fix updated: Simply bring your link styling inline. -->
            <p><a href="http://www.masterworksfineart.com" style="color: #004B91; text-decoration: none;">Stroll Through the Gallery</a></p>

        <table style="width: 90%">
            <tr>
                <td style="background: #e7e7c6; text-align: left; padding: 1em">
                    <h2>Thank you for your inquiry. We'll be getting back to you shortly! Thanks.</h2>
                </td>
                <td>
                </td>
            </tr>
            ...
            Oakland Hills, CA  94619<br />
            Tel  510-777-9970 / 800-805-7060<br />
            Fax  510.777.9972<br />
            Mobile  510.773.4835<br />
            Email  <a href="mailto:info@masterworksfineart.com">info@masterworksfineart.com</a><br />
            Web  <a href="http://www.masterworksfineart.com">www.MasterworksFineArt.com</a><br /><br />

            <p style="font-size:80%">PLEASE NOTE:  Due to the high volume of e-mails sent to us daily, you may experience a delay in response.  We will do our best to reply in a timely fashion.  If your inquiry is time-sensitive or urgent, you may contact us directly via telephone.<br /><br />

                The information contained herein is confidential and is intended solely for the addressee. The preceding e-mail message (including any attachments) contains information that may be confidential or privileged and is intended only for the individuals or entity named above.<br /><br />

                All messages and opinions expressed herein are those solely of the sender and are based upon his/her best knowledge at the time of sending.
            </p>
    ...
    <table cellpadding="0" cellspacing="0" border="0" align="center">
        <tr>
            ...
            <td width="200" valign="top">Artists</td>
            <td width="200" valign="top">Education</td>
            <td width="200" valign="top">About Us</td>
            <td width="200" valign="top">Contact Us</td>
        </tr>
    </table>
    -->
